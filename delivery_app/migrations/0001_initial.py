    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(default='Оплата наличными', max_length=100, verbose_name='Способ оплаты')),
                ('user_phone', models.CharField(max_length=50, verbose_name='Номер телефона')),
                ('user_comment', models.TextField(verbose_name='Комментарий от пользователя')),
